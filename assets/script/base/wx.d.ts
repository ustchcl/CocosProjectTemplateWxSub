...
declare interface BannderAd {
	...
	style: BannderAdStyle
}

declare interface RewardVedeioAd {
	load: () => void;
	show: () => void;
	onResize: (callback) => void;
	offResize: (callback) => void;
...
declare interface BannderAdStyle {
	left: number, 
	top: number, 
	width: number, 
	height: number,
...
declare const wx: {
    ...
    createRewardedVideoAd(obj: {adUnitId: string}): RewardVedeioAd;
    createBannerAd(obj: {adUnitId: string, style: BannderAdStyle}): BannderAd;
    /**
    ...
    getMenuButtonBoundingClientRect(): MenuInfo;
    /**
     ...
     * 显示消息提示框
     */
    showToast(object: { title: string, icon: string, duration: number, image?: Object, success?: (res: any) => void, fail?: (res: any) => void, complete?: (res: any) => void }): void;
